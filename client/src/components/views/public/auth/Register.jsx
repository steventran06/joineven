...
const Register = (props) => {
  ...
  const handleRegister = async (e) => {
    ...
    await register
      .local(values.firstName, values.lastName, values.email, values.password)
      .then((res) => {
        const { data } = res;
        if (data.status) {
          setError("");
          ...
          >
            ...
            {activeStep === steps.length ? (
              <React.Fragment>
                ...
                >
                  After Clicking{" "}
                  <b style={{ color: blue[500] }}>Create New Account</b>
                  Button below, We will sent a{" "}
                  <b style={{ color: red[500] }}>verification link</b> to your
                  email address.
                </Typography>
                    ...
                    >
                      <Grid item xs="10">
                        <FormControl
                          sx={{ width: "100%", mt: 2 }}
                          variant="outlined"
                          color={required.firstName ? "error" : "primary"}
                          focused={required.firstName ? true : false}
                        >
                          <TextField
                            id="text"
                            type={`text`}
                        ...
                        <FormControl
                          sx={{ width: "100%", mt: 2 }}
                          variant="outlined"
                          color={required.lastName ? "error" : "primary"}
                          focused={required.lastName ? true : false}
                        >
                          <TextField
                            id="text"
                            type={`text`}
